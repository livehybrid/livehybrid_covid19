...
SCHEME = """<scheme>
    <title>Covid-19 UK Only - NHS Regions</title>
    <description>Poll for Covid-19 UK Regional cases by NHS region</description>
...
def do_run():
    ...
    try:
        ...
        while True:
            ...
            req = requests.get(url="https://services1.arcgis.com/0IrmI40n5ZYxTUrV/arcgis/rest/services/NHSR_Cases_table/FeatureServer/0/query?where=1%3D1&objectIds=&time=&resultType=none&outFields=*&returnIdsOnly=false&returnUniqueIdsOnly=false&returnCountOnly=false&returnDistinctValues=false&cacheHint=false&orderByFields=&groupByFieldsForStatistics=&outStatistics=&having=&resultOffset=&resultRecordCount=&sqlFormat=none&f=pjson&token=", params=req_args)
            resp = req.json()
            for feature in resp['features']:
                handle_output(json.dumps(feature['attributes']),"arcgis:phe:nhsregions")
